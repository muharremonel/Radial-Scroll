        ...
        className='mt-3'
          control={
            ...
            className='mb-4'
              ...
              color="primary"
              name="messageConsent"
              checked={formValues.messageConsent}
              onChange={handleChange}
            />
          }
          label={
            <>
              <Typography component="span">
                ...
                Kanun (“ETK”) Kapsamında IAS Bilgi İşlem Danışmanlık
                Sanayi Ve Ticaret Anonim Şirketi Tarafından Ticari
                Elektronik İleti (E-posta, SMS mesaj, Arama) gönderilmesine
                onay veriyorum.
              </Typography>
            </>
          }
